    <!-- About Section -->
    <section id="about" class="py-20 lg:px-10 bg-gray-800">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-4xl md:text-5xl font-bold italic mb-4">About Swoosh</h2>
                <p class="text-gray-400 text-lg">Your Trusted Partner in Car Care Excellence</p>
            </div>
